...
public class TableHeadersAndRowsVerification extends CommonMethods {
...
//	Close browser
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int i=1; i<=rows.size(); i++) {
			String actualText=driver.findElement(By.xpath("//table[contains(@id, 'orderGrid')]/tbody/tr["+i+"]")).getText();
